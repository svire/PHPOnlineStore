                ...
                <div class="admin_form">
                    ...
                    <div   class="formtwoitem" style="   flex:100%;min-height:220px; display:flex;flex-direction:row;   align-items:flex-start;  ">
                        <div  style=' display:flex;flex-direction:column; '  > 
                            ...
                            <div style='margin-top:20px; width:100%;height:100px;display:flex;flex-direction:row;'>
                                <div style='background-color:red;height:98%;width:100px;margin:10px;'>
                                    <img   src="../../slike/download.jpg" width="100%" height="100%" border="1"/>
                                </div>
                            </div>
                        </div>
                    </div> 
                ...
                <div style=' width:100%;height:100px;display:flex;flex-direction:row;'>
                    ...
                    if (empty($_SESSION['pic_alo'])) {
                        ...
                        for ($i = 0; $i < count($_SESSION['pic_alo']); $i++) {
                            ...
                            ?>
                            <div style='background-color:red;height:98%;width:100px;margin:10px;'>
                                <img src="<?php echo $_SESSION['pic_alo'][$i]; ?>" width="100%" height="100%" border="1"/>
                            </div>
                            <?php
                        }
                    }
