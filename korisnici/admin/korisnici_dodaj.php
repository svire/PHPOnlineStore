<html>
    ...
    <body>
        ...
        ?>
        <h1 style="text-align: center";><span class="promoted">***</span>Add user<span class="promoted">***</span></h1>
        ...
        <form method="post" action="korisnici_dodaj_baza.php" onsubmit="return forma()">
