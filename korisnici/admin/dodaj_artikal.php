...
if (empty($_SESSION['pic_alo'])) {
    ...
    for ($i = 0; $i < count($_SESSION['pic_alo']); $i++) {
        ...
        ?>
                    ...
                    <div align='center'>
                        <input type='submit' class='Button3' value='UPLOAD PHOTO' style='width:20%;text-align:center;' />
        ...
        <form enctype="multipart/form-data" action="dodaj_artikal_baza.php" method="post" onsubmit="return forma()">
            <div class="admin_form">
                ...
                <div align='center'>
                    <input type='submit' class='Button3' value='Add product ' style='width:30%;text-align:center;' />
